...
export default function HeroSection() {
  return (
    <section
      className="relative w-full h-[760px] bg-cover bg-center"
    ...
    >
      ...
      {/* container */}
      <div className="relative z-10 max-w-[1320px] w-full mx-auto px-6 flex flex-col h-full">
      ...
      <div className="absolute bottom-[120px] w-full">
        ...
        <div className="max-w-[1320px] mx-auto px-6 text-white">

          <h2 className="text-[50px] mt-[140px] leading-[60px]">
