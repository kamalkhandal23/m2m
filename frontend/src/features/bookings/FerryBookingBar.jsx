  ...
  export default function FerryBookingBar() {
    return (
      <div className="absolute left-1/2 -translate-x-1/2 top-[110px] z-30 w-full max-w-[1200px] px-4">
        ...
        {/* Schedule Notice */}
        <div className="absolute right-0 -top-8 flex items-center gap-2 text-white text-sm">
          <div className="w-4 h-4 border-2 border-white rounded-full"></div>
          <span>Schedule is live till 27th January 2026.</span>
        </div>
  
        {/* Booking Bar */}
        <div className="relative flex items-center bg-white rounded-[24px] shadow-xl overflow-hidden">
